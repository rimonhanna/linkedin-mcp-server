...
class EnvironmentKeys:
    ...
    # Rolling caps per kind of activity. Each may lower its default in
    # ``pacing.py``, never raise it. WORKING_HOURS_DISABLED lifts the schedule
    # gate on writes and the halved read caps outside it.
    PROFILE_LOADS_MAX = "PROFILE_LOADS_MAX"
    SEARCH_PAGES_MAX = "SEARCH_PAGES_MAX"
    INVITES_MAX = "INVITES_MAX"
    INVITES_WEEKLY_MAX = "INVITES_WEEKLY_MAX"
    MESSAGES_MAX = "MESSAGES_MAX"
    WORKING_HOURS_DISABLED = "WORKING_HOURS_DISABLED"
